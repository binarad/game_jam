...
void fonts_debug_draw()
{
    ...
    DrawTextEx(_get_font(FontSize::HUGE_SIZE), "HUGE", pos, wr_y(_font_to_percent.at(FontSize::HUGE_SIZE)), FONTS_SPACING, GREEN);
    pos.y += 30;
}
